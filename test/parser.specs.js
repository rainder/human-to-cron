...
describe('parser tests', function () {
  it('should return expected values', function () {
    ...
    expect(parser('tuesday every 10 minutes')).to.be.equal('* */10 * 1 * *');
    ...
    expect(parser('once every 2 months')).to.be.equal('0 0 0 0 */2 *');
    expect(parser('once every 2 months at 14:00')).to.be.equal('0 0 14 0 */2 *');
